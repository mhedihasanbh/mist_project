...
<body class="">
	...
	<nav <body style="background-color:green;" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					...
					<li class="dropdown pull-right notification">
						<a body style="background-color:red;" href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<li  class="dropdown pull-right notification">
						...
						<ul body style="background-color:red;"class="dropdown-menu" role="menu">
							<li>
								<a  href="borrow">
