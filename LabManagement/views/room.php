...
<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 col-lg-10 col-lg-offset-2 main">	
	<div class="row">
		...
		<div class="breadcrumb">
			<button <body style="background-color:red;" class="btn btn-primary col-sm-offset-10 add_room">
				<svg class="glyph stroked plus sign">
					<use xlink:href="#stroked-plus-sign"/>
				</svg>
				Add Room
	...
	<div class="sidebar-form">
		<div class="container-fluid">
			<form class="frm_addroom">
				<h4 <body style="background-color:red;"class="alert bg-success"><i class="fa fa-plus"</i> Add Room</h4>
				<div class="form-group">
